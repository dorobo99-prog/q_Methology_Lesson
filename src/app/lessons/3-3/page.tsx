...
const cards = [
  {
    ...
    body: (
      <>
        ...
        <p>
          Q방법론의 절차로 들어가기 전에 먼저 던져야 할 질문이 있다.<br />
          왜 Q방법론에는 이런 절차가 필요한가?
        </p>

        <p>
          이 질문을 건너뛰면 concourse, Q-set, P-set, Q-sort, 요인분석, 해석은 그저 순서대로 처리해야 할 작업 목록이 된다.<br />
          그 순간 Q방법론은 하나의 체크리스트처럼 보이기 쉽다.
        </p>

        <p>
          Brown(1980)은 Q방법론이 주관성을 연구하는 방법론임을 보여주었다.<br />
          하지만 주관성은 연구자가 바깥에서 곧바로 재거나 꺼내 볼 수 있는 대상이 아니다.
        </p>

        <p>
          참여자가 자기 관점에서 진술문을 비교하고 배열하는 장면이 필요하다.<br />
          그 장면에서 주관성은 연구자가 다룰 수 있는 자료의 형태로 나타난다.
        </p>

        <p>
          Watts &amp; Stenner(2012)의 기여는 이 지점을 현대 연구 절차로 정리했다는 데 있다.<br />
          이들은 Q방법론의 이론, 자료 수집, 분석, 해석을 따로 떨어진 조각으로 보지 않는다.
        </p>

        <p>
          Q-sort는 자료가 생성되는 장면이고, 요인분석은 그 자료를 비교하는 장치다.<br />
          여기에 factor array를 읽어내는 해석 작업이 이어진다.
        </p>

        <p>
          이 흐름이 서로 연결될 때 Q방법론은 단순한 절차가 아니라 하나의 연구 방법론이 된다.<br />
          절차는 주관성이 자료로 나타나게 하는 조건이자, 그 자료를 비교할 수 있게 만드는 형식이다.
        </p>

        <p>
          나아가 절차는 분석 결과를 다시 연구질문의 언어로 되돌리는 길이기도 하다.<br />
          그래서 절차 체크리스트는 필요하지만, 그것만으로는 충분하지 않다.
        </p>

        <p>
          체크리스트는 무엇을 빠뜨리지 않게 도와준다.<br />
          그러나 왜 그 단계를 밟아야 하는지는 설명하지 못한다.
        </p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          Concourse는 특정 주제를 두고 사람들이 말하고, 생각하고, 느끼고, 논쟁할 수 있는 표현의 세계를 가리킨다.
        </p>

        <p>
          정책문서, 인터뷰, 뉴스, 현장 경험, 기존 연구, 일상 대화에서 나온 말들은 모두 concourse의 재료가 될 수 있다.<br />
          말하자면 concourse는 그 주제에 대해 말해질 수 있는 세계다.
        </p>

        <p>
          여기서 중요한 점은 Q방법론이 연구자가 미리 정한 척도에서 곧장 출발하지 않는다는 데 있다.<br />
          Q방법론은 먼저 사람들이 실제로 사용하는 언어와 의미의 장을 연다.
        </p>

        <p>
          주관성을 연구하려면, 그 주관성이 표현될 수 있는 말의 세계를 먼저 확보해야 한다.<br />
          Q-set은 이 세계를 연구 가능한 형태로 정리한 것이다.
        </p>

        <p>
          물론 concourse 전체를 그대로 Q-sort에 넣을 수는 없다.<br />
          진술문이 너무 많으면 참여자는 그것들을 비교하고 배열하기 어렵다.
        </p>

        <p>
          반대로 진술문이 지나치게 좁으면 관점의 차이가 충분히 드러나지 않는다.<br />
          그래서 연구자는 concourse를 연구 가능한 축소판, 곧 Q-set으로 만든다.
        </p>

        <p>
          van Exel &amp; de Graaf(2005)는 Q-set을 concourse의 대표적 축소판으로 이해하도록 돕는다.<br />
          이 표현이 중요한 이유는 Q-set이 단순한 문항 목록이 아니기 때문이다.
        </p>

        <p>
          Q-set은 말해질 수 있는 세계를 참여자가 실제로 배열할 수 있는 연구 장치로 바꾼 것이다.<br />
          다시 말해 Q-set은 주관성의 세계를 배열 가능한 카드 묶음으로 옮기는 단계다.
        </p>

        <p>
          이 지점에서 Brown의 이론은 절차 속으로 들어온다.<br />
          주관성이 배열로 나타나려면, 먼저 배열될 진술문들이 있어야 한다.
        </p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          하지만 이 질문을 모집단 대표성의 언어로만 이해하면 Q방법론의 논리가 흐려진다.<br />
          Q방법론에서 P-set은 인구 비율을 추정하기 위한 표본이 아니다.
        </p>

        <p>
          여기서 더 중요한 질문은 따로 있다.<br />
          누가 이 주제에 대해 의미 있는 관점을 배열할 수 있는가?
        </p>

        <p>
          어떤 사람들이 서로 다른 경험, 위치, 이해관계, 가치 판단을 바탕으로 Q-set을 다르게 읽을 가능성이 있는가?<br />
          P-set은 이런 관점의 다양성을 확보하기 위한 참여자 구성이다.
        </p>

        <p>
          McKeown &amp; Thomas(2013)는 Q방법론이 자기 참조에 기반한다고 설명한다.<br />
          참여자는 외부 기준에 맞춰 정답을 고르는 사람이 아니다.
        </p>

        <p>
          참여자는 자기 관점에서 진술문들을 배열하는 사람이다.<br />
          그래서 P-set은 “모집단을 얼마나 닮았는가”보다 “이 주제의 세계를 얼마나 의미 있게 배열할 수 있는가”로 정당화된다.
        </p>
        ...
        <p>
          ...
          같은 카드라도 기준이 달라지면 배열의 의미도 달라진다.
        </p>

        <p>
          이 점에서 P-set과 지시 조건은 단순한 운영 절차가 아니다.<br />
          P-set은 누가 주관성을 표현할 것인지를 정하고, 지시 조건은 그 주관성이 어떤 기준으로 작동할 것인지를 정한다.
        </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
      ...
      <section className="mb-10 pt-8" style={{ borderTop: "1px solid rgba(0,0,0,0.08)" }}>
        ...
        <p>
          Q방법론을 처음 배우면 대개 절차부터 붙잡게 된다.<br />
          Concourse를 만들고, Q-set을 고르고, P-set을 정한 뒤, Q-sort와 요인분석, 해석으로 이어지는 흐름을 먼저 떠올린다.
        </p>

        <p>
          그 순서 자체가 틀린 것은 아니다.<br />
          다만 절차만 남으면 Q방법론은 조금 특이한 설문조사나 통계 처리법처럼 보이기 쉽다.
        </p>

        <p>
          3-2강에서 우리는 Brown(1980)을 통해 Q방법론이 무엇을 연구하는 방법론인지 살펴보았다.<br />
          Q방법론은 많은 사람을 모아 평균을 내는 방식도 아니고, R방법론의 행렬을 단순히 뒤집은 계산법도 아니다.
        </p>

        <p>
          Q방법론이 보려는 것은 사람이 자기 세계를 의미 있게 배열하는 방식이다.<br />
          그리고 그런 배열들 사이에서 어떤 공유된 관점 구조가 드러나는지를 연구한다.
        </p>

        <p>
          여기서 자연스럽게 한 가지 질문이 따라온다.<br />
          그렇다면 그런 주관성은 어떻게 연구 자료가 될 수 있을까?
        </p>

        <p>
          “주관성을 연구한다”는 말만으로 연구가 성립하지는 않는다.<br />
          참여자가 자기 관점을 표현할 수 있는 장면이 있어야 하고, 그 배열들을 비교할 수 있는 분석 절차도 필요하다.
        </p>

        <p>
          분석된 패턴을 다시 의미 있는 관점으로 읽어내는 해석의 언어 역시 필요하다.<br />
          Watts &amp; Stenner(2012)가 중요한 이유는 여기에 있다.
        </p>

        <p>
          Watts &amp; Stenner는 Q방법론을 철학적 선언에 머물게 두지 않는다.<br />
          Q의 역사와 이론에서 출발해 Q-sort, 요인배열, 해석으로 이어지는 연구 수행의 언어를 마련한다.
        </p>

        <p>
          그래서 이 강의에서 Watts &amp; Stenner는 단순한 절차 교재의 저자가 아니다.<br />
          Brown의 이론과 실제 연구 실행 사이를 이어주는 안내자에 가깝다.
        </p>

        <p>
          이때 절차는 이론 바깥에 덧붙은 부록이 아니다.<br />
          조작적 주관성은 Q-sort에서 표현되고, 개인내 유의성은 Q-sort 안에서 진술문들이 이루는 상대적 질서로 나타난다.
        </p>

        <p>
          절차는 주관성 이론이 관찰 가능한 연구 장면으로 바뀌는 형식이다.<br />
          3-3강은 이 형식이 어떻게 만들어지는지를 따라간다.
        </p>

        <p>
          오늘은 Q-set을 몇 개로 줄일지, 요인 수를 어떻게 결정할지, 소프트웨어를 어떻게 조작할지를 배우는 시간이 아니다.<br />
          이후 절차 강의로 들어가기 전에, 먼저 왜 그런 절차가 필요한지를 이해하는 것이 오늘의 목표다.
        </p>
        </div>
      </section>
