...
const cards: Card[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Kirschbaum et al.(2024)은 사후 인터뷰를 '흔히 간과되는 단계'로 지적하며, 혼합연구방법 통합의 별도 가닥으로 설계하는 접근을 제안합니다.",
    points: [
      "양극단(-4, +4)에 놓인 진술문과 예상치 못한 위치의 항목에 집중해 인터뷰를 진행한다.",
      "인터뷰 데이터는 Q-sort 분석의 부수적 메모가 아니라 별도로 분석하고 통합할 수 있는 독립적 자료 층이다.",
      "인터뷰 없이는 배열만으로 의미를 해석해야 하므로 참여자 의도와의 간격이 커진다.",
    ],
  },
  {
    num: 6,
  ...
  switch (num) {
    ...
    case 5:
      return (
        <div className="lesson-card-body space-y-5" style={style}>
          <p>
            Q-sort 배열이 끝났다고 해서 자료 수집이 끝난 것이 아닙니다. 강력한 Q방법론 연구는 배열 이후에 참여자와 짧은 인터뷰를 진행합니다. 이 사후 인터뷰는 연구자의 선택이 아니라 해석의 신뢰를 위한 필수 단계입니다.
          </p>
          <p>
            사후 인터뷰에서는 특히 두 가지 유형의 진술문에 집중합니다. 양극단(가장 동의하거나 가장 비동의한 위치)에 놓인 진술문은 왜 그 위치에 두었는지 직접 물어볼 수 있습니다. 중간에 놓인 진술문 중 연구자가 예상치 못한 위치에 있는 항목도 확인 대상이 됩니다. 참여자의 설명은 이후 요인 해석 단계에서 가장 중요한 맥락 자료가 됩니다.
          </p>
          <p>
