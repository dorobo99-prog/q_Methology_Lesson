    ...
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
      ...
      <section className="mb-10 pt-8" style={{ borderTop: "1px solid rgba(0,0,0,0.08)" }}>
        ...
        <p>
          답은 이미 나왔다.
          <br />
          Q방법론 (Q methodology)은 단순한 행렬 전치로 끝나지 않는다.
        </p>

        <p>
          Q는 사람들이 자기 세계를 어떻게 배열하는지를 자료로 삼는다.
          <br />
          그리고 그 배열들 사이의 유사성을 따라가며, 공유된 관점의 구조를 드러낸다.
        </p>

        <p>
          하지만 여기서 더 어려운 질문이 남는다.
          <br />
          독자적 방법론이라고 해서, 곧바로 연구 전통이 되는 것은 아니다.
        </p>

        <p>
          주류와 다른 언어를 가진 방법론은 어떻게 사라지지 않는가.
          <br />
          누가 그 언어를 붙들고, 누가 다시 설명하고, 누가 다음 연구자가 따라 할 수 있는 절차로 바꾸는가.
        </p>

        <p>
          Stephenson(1953)은 Q기법을 주관적 행동을 연구하는 독자적 방법론으로 세웠다.
          <br />
          그러나 Good(2010)이 보여주듯, 그 문제의식은 곧바로 주류 심리학의 중심으로 들어가지 못했다.
        </p>

        <p>
          그렇다고 이 역사를 실패담으로 읽으면 안 된다.
          <br />
          중심에서 비켜 있었다는 말은, 사라졌다는 말이 아니기 때문이다.
        </p>

        <p>
          오히려 Q방법론은 다른 공동체 속에서 살아남았다.
          <br />
          Brown은 그것을 사회과학의 언어로 다시 세웠고, 연구자 공동체는 그 언어를 이어 갔으며, 현대 교재와 응용 연구는 그것을 실제 절차와 사례로 축적했다.
        </p>

        <p>
          3-1강은 바로 그 전개를 본다.
          <br />
          한 사람의 문제의식이 어떻게 하나의 연구 전통으로 이어졌는지, 그 지도를 먼저 펼쳐 보려 한다.
        </p>
