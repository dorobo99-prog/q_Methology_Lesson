    ...
    chapters: [
      {
        ...
        lessons: [
          ...
          {
            id: "5-4", order: 504, status: "open",
            title: "Q-set 구성",
            href: "/lessons/5-4",
            description: "Q-set 구성 강의입니다.",
            image: "/images/5-4-hero-q-set-construction.webp",
            publishedAt: "2026-06-26",
          },
          {
            id: "5-5", order: 505, status: "open",
            title: "P-set 선정",
            href: "/lessons/5-5",
            description: "P-set을 모집단의 축소판이 아니라 관점 다양성을 드러내는 전략적 참여자 구성으로 설계하는 법을 배웁니다.",
            image: "/images/5-5-hero-p-set-selection.webp",
            publishedAt: "2026-07-02",
          },
          {
            id: "5-6", order: 506, status: "open",
            title: "Q-sort 시행",
            href: "/lessons/5-6",
            description: "강제분포 그리드, 시행 지시문, 온라인 Q-sort, 사후 인터뷰까지—Q-sort 시행의 전 과정을 설계합니다.",
            image: "/images/5-6-hero-q-sort-administration.webp",
            publishedAt: "2026-07-05",
          },
          { id: "5-7", order: 507, status: "locked", title: "요인분석에서 해석까지의 흐름" },
